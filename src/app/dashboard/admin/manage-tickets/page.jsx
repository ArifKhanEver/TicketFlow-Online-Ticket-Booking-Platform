...
import { 
  ...
  FiLayers, FiDollarSign, FiInfo, FiClock, FiCheckCircle, FiXCircle 
} from 'react-icons/fi';
...
export default function ManageTicketsPage() {
  ...
  // ১. অ্যাডমিন মডারেশনের জন্য রিচ ডামি টিকিট ডাটা সেট
  const [tickets, setTickets] = useState([
    {
      ...
      vendorName: "M/S Hanif Transport",
    ...
    },
    {
      ...
      vendorName: "Green Line Operators",
      status: "pending"
    },
    {
      _id: "t_803",
      ...
      status: "approved" // এপ্রুভড স্টেট (এটি All Tickets পেজে যাবে)
    },
    {
      _id: "t_804",
      ...
      vendorName: "US-Bangla Air Logistics",
  ...
  // ২. টিকিট স্ট্যাটাস পরিবর্তনের মক হ্যান্ডলার (Approve / Reject Pipeline)
  ...
  // ৩. লাইভ সার্চ ফিল্টারিং লজিক (টাইটেল, ভেন্ডর বা রুট দিয়ে খোঁজা যাবে)
    ...
    >
      ...
      {filteredTickets.length > 0 ? (
        <div className="w-full">
          ...
          {/* A) MOBILE RESPONSIVE VIEW: Stacked Grid Layout Cards */}
          ...
          {/* B) DESKTOP VIEW: Corporate Compact Grid Table Layout */}
                ...
                <AnimatePresence mode="popLayout">
                  {filteredTickets.map((ticket) => {
                    ...
                    return (
                      ...
                      >
                        {/* 1. Ticket Name and Vendor Identifier */}
                        ...
                        {/* 3. Expected Departure Timestamp */}
                        ...
                        {/* 4. Stock Allocation Constraints vs Pricing Fare Rates */}
                        ...
                        {/* 5. Moderation Verification Tokens Status Badge */}
                        ...
                        {/* 6. Requirement Match: Action Button Matrix Pills */}
                        <td className="px-6 py-3.5 align-middle text-center whitespace-nowrap">
                          {ticket.status === 'pending' ? (
